...
var todos_api_1 = require("../api/todos-api");
var Todos = /** @class */ (function (_super) {
    ...
    function Todos() {
        ...
        _this.onEditButtonClick = function (todoId) {
            _this.props.history.push("/todos/" + todoId + "/edit");
        };
        _this.onTodoCreate = function (event) { return __awaiter(_this, void 0, void 0, function () {
            var dueDate, newTodo, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        dueDate = this.calculateDueDate();
                        return [4 /*yield*/, todos_api_1.createTodo(this.props.auth.getIdToken(), {
                    ...
                    case 1:
                        newTodo = _b.sent();
                        this.setState({
                            todos: __spreadArrays(this.state.todos, [newTodo]),
                            newTodoName: ''
                        });
                        return [3 /*break*/, 3];
                    case 2:
        ...
        _this.onTodoDelete = function (todoId) { return __awaiter(_this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, todos_api_1.deleteTodo(this.props.auth.getIdToken(), todoId)];
                    case 1:
                        _b.sent();
                        this.setState({
                            todos: this.state.todos.filter(function (todo) { return todo.todoId !== todoId; })
                        });
                        return [3 /*break*/, 3];
                    case 2:
                        _a = _b.sent();
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, todos_api_1.patchTodo(this.props.auth.getIdToken(), todo.todoId, {
                                name: todo.name,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, todos_api_1.getTodos(this.props.auth.getIdToken())];
                    case 1:
                        todos = _a.sent();
                    ...
                    case 2:
                        e_1 = _a.sent();
                        alert("Failed to fetch todos: " + e_1.message);
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
    ...
    Todos.prototype.renderTodosList = function () {
        ...
        return (React.createElement(semantic_ui_react_1.Grid, { padded: true }, this.state.todos.map(function (todo, pos) {
            return (React.createElement(semantic_ui_react_1.Grid.Row, { key: todo.todoId },
                ...
                React.createElement(semantic_ui_react_1.Grid.Column, { width: 1, floated: "right" },
                    React.createElement(semantic_ui_react_1.Button, { icon: true, color: "blue", onClick: function () { return _this.onEditButtonClick(todo.todoId); } },
                        React.createElement(semantic_ui_react_1.Icon, { name: "pencil" }))),
                React.createElement(semantic_ui_react_1.Grid.Column, { width: 1, floated: "right" },
                    React.createElement(semantic_ui_react_1.Button, { icon: true, color: "red", onClick: function () { return _this.onTodoDelete(todo.todoId); } },
